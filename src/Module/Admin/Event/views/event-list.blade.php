 ...
 * @var  $vm        \Lyrasoft\EventBooking\Module\Admin\Event\EventListView The view model object.
            ...
            <table class="table table-striped table-hover">
                ...
                @forelse($items as $i => $item)
                    <tr>
                        ...
                        <td>
                            <div>
                                <a href="{{ $nav->to('event_edit')->id($item->getId()) }}">
                                    {{ $item->getTitle() }}
                                </a>
                            </div>
                        </td>

 ...
 * @var  $vm        \Lyrasoft\EventBooking\Module\Admin\Venue\VenueListView The view model object.
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <th class="text-nowrap" style="width: 3%">
                        <x-sort field="venue.category_id">
                            分類
                        </x-sort>
                    </th>
